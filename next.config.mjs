...
const nextConfig = {
  ...
  async redirects() {
    return [
      // Racores neumáticos -> Accesorios Neumáticos (135 referencias organizadas en 13 familias).
      { source: "/categorias/conexiones-rapidas", destination: "/categorias/accesorios-neumaticos", permanent: true },
      // "Fitting" -> "Conectores neumáticos": consolidados en un solo producto maestro configurable.
      { source: "/productos/fitting-recto", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/fitting-tee", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/fitting-codo-90", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/fitting-union-recta", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/fitting-union-y", destination: "/categorias/accesorios-neumaticos", permanent: true },
      // El master único "Conectores Neumáticos" se reemplazó por 29 productos, uno por tipo real.
      { source: "/productos/conectores-neumaticos", destination: "/categorias/accesorios-neumaticos", permanent: true },
      ...
      { source: "/productos/conector-recto-macho", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/conector-recto-hembra", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/union-reductora", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/codo-hembra", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/codo-union", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/t-reductora", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/t-macho", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/cruz", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/pasamuros", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/tapon", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/tapon-macho", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/silenciador", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/regulador-de-caudal-recto", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/regulador-de-caudal-codo", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/check-valve", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/acople-rapido-macho", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/acople-rapido-hembra", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/conector-espiral", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/conector-giratorio", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/adaptador-bsp", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/adaptador-npt", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/adaptador-macho", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/adaptador-hembra", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/conector-doble-codo", destination: "/categorias/accesorios-neumaticos", permanent: true },
      { source: "/productos/conector-push-in-universal", destination: "/categorias/accesorios-neumaticos", permanent: true },
